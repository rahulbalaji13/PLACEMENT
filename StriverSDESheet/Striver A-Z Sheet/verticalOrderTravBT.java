/**
987. Vertical Order Traversal of a Binary Tree (Time complexity: O(NLogN)
...
class Solution 
{
    ...
    public List<List<Integer>> verticalTraversal(TreeNode root) 
    {
         ...
         levelorder(root,0,0);  //Root,Index and Level(Priority Queue)
         
         List<List<Integer>> res = new LinkedList<>();
         for(int key : map.keySet())
         {
             List<Integer> list = new LinkedList<>();
             TreeMap<Integer, PriorityQueue<Integer>> tm = map.get(key); // Tree map to get iterated node values in dfs and display the output as list (Index, Level)
